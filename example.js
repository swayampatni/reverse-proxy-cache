...
var backend1 = new reverseP.Backend({port: 9001, timeout: 1}),
	backend2 = new reverseP.Backend({port: 9002}),
	backend3 = new reverseP.Backend({port: 9003}); // error
	
var cacheDb = new reverseP.RedisDatabase(),
	cacheManager = new reverseP.CacheManager(cacheDb);

var ruleSuite = new reverseP.RuleSuite();
